...
1. Snapshot Debugging on the watch
   ...
   2. It also is happy to send me an old snapshot instead of indicating failure.
         ...
         2. That's bad.
2. Obviously the bluetooth pi reader is a good idea as well.

3. Need Camera to Veify it's ***Benny*** who eats his food
   1. or verify kibble hits the bowl (not just manually)
   2. Benny goes to eat the food
4. Dogs getting into food early
5. Massive Watch software update
   1. New Functions
   2. New Interface
            1. (descending tiles)
6. 1. It's really inconvenient leaving my cellphone at home - we could avoid 90% of the issues with the watch by simply getting another phone to leave with him
...
3. Talk to Benny
4. Oh I wish we had a better rug
5. Bike with a basket on the front for Benny
6. I could really use a backpack for benny
7. How to fish with Benny

## Sorta Fun/Relief/QOL

1. Buy longer-running uninterruptible PSU
2. Camera detecting successful dispensation
3. Camera detecting consumption
4. More BCS backup/failure modes
5. Things kinda need to be routed around the basic assumption that there's a human on call
6. What else - toenail trimming is really hard
